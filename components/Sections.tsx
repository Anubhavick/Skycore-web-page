        ...
        <section id="about-section" className="bg-brand-dark text-white">
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                         <img src="https://picsum.photos/seed/mission/800/600" alt="Flight school hangar" className="rounded-lg shadow-lg" />
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {pillars.map(pillar => (
                            <div key={pillar.title} className="group bg-brand-dark p-8 rounded-lg text-center border border-gray-100/10 transition-all duration-300 hover:border-brand-blue/50 hover:shadow-lg hover:shadow-brand-blue/10">
                                <i className={`fa-solid ${pillar.icon} text-4xl text-brand-blue mb-4 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-12`}></i>
                    ...
                    {INSTRUCTORS.map(instructor => (
                        <div key={instructor.name} className="bg-brand-gray rounded-lg overflow-hidden text-center border border-gray-100/10">
                            ...
                            <div className="p-6">
                                ...
                                <p className="text-brand-blue font-semibold">{instructor.title}</p>
