                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-4 text-brand-light-gray">
                            <li className="flex items-start"><i className="fa-solid fa-map-marker-alt mt-1 mr-3 text-[#6ED25D]"></i>123 Aviation Rd, Delhi, India</li>
                            <li className="flex items-start"><i className="fa-solid fa-phone mt-1 mr-3 text-[#6ED25D]"></i>+91 xxxxx xxxxx</li>
                            <li className="flex items-start"><i className="fa-solid fa-envelope mt-1 mr-3 text-[#6ED25D]"></i>skycore@gmail.com</li>
                        </ul>
                    </div>
                </div>
                <div className="mt-8 border-t border-gray-700 pt-8 text-center text-base text-brand-light-gray">
                    &copy; {new Date().getFullYear()} Skycore Flight Academy. All rights reserved.
                </div>
            </div>
        </footer>
    );
